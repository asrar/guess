...
class Guessing extends StatelessWidget {
    ...
    return MainWidget(
      ...
      padding: EdgeInsets.only(top: 60.h, left: 25.w, right: 25.w),
          child: Column(
            ...
            children: [  HomeNameSetting(onTapHome: (){
              _Home(context);
            }, text: 'You,re Guessing',),
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    InkWell(
                        ...
                        child: Image.asset('assets/images/sendbtn.png', height: 45.h, width: 45.w,))
                  ],
                ),
              )
